...
function Orenda({ hidden, onChangeHidden3}) {
  ...
  return (
    <div className="">
      <div className="Jet-page-container" hidden={hidden} style={{'zIndex': 60}}  id="jet-element" onClick={(event)=>handleZ(event)}>
      <Draggable  handle="#handle">
        <div className="Jet-nav-container" >
              ...
              <div className='Jet-inter-buttons'>
                  ...
                  <div className='Jet-inter-buttons-yellow'  onClick={handleclose2}></div>
                  <div className='Jet-inter-buttons-green'  onClick={handleclose2}></div>
              </div>
